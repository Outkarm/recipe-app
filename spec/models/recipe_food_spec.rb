...
RSpec.describe RecipeFood, type: :model do
  ...
  let(:food1) {FactoryBot.create(:food, user_id: user1.id, name: 'Jollof Rice', measurement_unit: 'Cup', price: 100, quantity: 1)}
  let(:food2) {FactoryBot.create(:food, user_id: user1.id, name: 'Fried Rice', measurement_unit: 'Cup', price: 100, quantity: 1)}
