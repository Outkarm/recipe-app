...
RSpec.feature "Recipes", type: :feature do
  ...
  describe 'Recipe Index Page' do
    before :each do
      ...
      @user.confirm
      @user
      @recipe1 = Recipe.create(name:'Recipe 1',preparation_time: 1 ,cooking_time: 2,description:'making sense',public: true, user_id: @user.id)
      @recipe2 = Recipe.create(name:'Recipe 2',preparation_time: 1 ,cooking_time: 2,description:'making sense',public: true, user_id: @user.id)
      @recipe3 = Recipe.create(name:'Recipe 3',preparation_time: 1 ,cooking_time: 2,description:'making sense',public: true, user_id: @user.id)
